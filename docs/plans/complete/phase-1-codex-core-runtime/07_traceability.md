...
| AC-P1-024 | local quality, 90.38% coverage, build, artifacts and docs; remote matrix | Satisfied: local gates plus [CI run 34931792468](https://github.com/fernan2cp/proteo-runtime/actions/runs/34931792468) passed all quality, Ubuntu/Windows 3.11–3.14, and packaging jobs |
